...
export class ProcurementService {
  ...
  updateStatus(
    ...
    console.log('updateStatus - Raw params:', { id, statusField, value, comment });
    
    switch(statusField) {
      case 'bid_specification':
        updateData.bid_specification = value;
        break;
      case 'advert':
        updateData.advert = value;
        updateData.status_advertised = value ? true : false;
        break;
      case 'bid_closing':
        updateData.bid_closing = value;
        break;
      case 'bid_evaluation':
        updateData.bid_evaluation = value;
        updateData.status_evaluated = value ? true : false;
        break;
      case 'bid_award':
        updateData.bid_award = value;
        updateData.status_awarded = value ? true : false;
        break;
      default:
        updateData[statusField] = value;
    }
    ...
    console.log('ProcurementService.updateStatus - Request payload:', updateData);
